...
namespace Kaltura
{
	public class KalturaRule : KalturaObjectBase
	{
		...
		private IList<KalturaAccessControlAction> _Actions;
		...
		public IList<KalturaAccessControlAction> Actions
		{
			get { return _Actions; }
			set 
			{ 
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					case "message":
						...
						continue;
					case "actions":
						this.Actions = new List<KalturaAccessControlAction>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.Actions.Add((KalturaAccessControlAction)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "conditions":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.Conditions.Add((KalturaCondition)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "contexts":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.Contexts.Add((KalturaAccessControlContextTypeHolder)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "stopProcessing":
		...
		public override KalturaParams ToParams()
		{
			...
			if (this.Actions != null)
			{
				...
				{
					int i = 0;
					foreach (KalturaAccessControlAction item in this.Actions)
					{
