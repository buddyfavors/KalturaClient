...
namespace Kaltura
{
	public class KalturaTransformMetadataResponse : KalturaObjectBase
	{
		...
		public KalturaTransformMetadataResponse(XmlElement node)
		{
		...
		public override KalturaParams ToParams()
		{
			...
			kparams.AddReplace("objectType", "KalturaTransformMetadataResponse");
