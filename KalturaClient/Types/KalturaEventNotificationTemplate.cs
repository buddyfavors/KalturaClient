			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "eventConditions":
						...
						{
							this.EventConditions.Add((KalturaCondition)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "contentParameters":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.ContentParameters.Add((KalturaEventNotificationParameter)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "userParameters":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.UserParameters.Add((KalturaEventNotificationParameter)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
				}
			}
