...
namespace Kaltura
{
	public class KalturaEntryContextDataResult : KalturaObjectBase
	{
		...
		private IList<KalturaAccessControlAction> _AccessControlActions;
		...
		public IList<KalturaAccessControlAction> AccessControlActions
		{
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "accessControlMessages":
						...
						{
							this.AccessControlMessages.Add((KalturaString)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "accessControlActions":
						this.AccessControlActions = new List<KalturaAccessControlAction>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.AccessControlActions.Add((KalturaAccessControlAction)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "flavorAssets":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.FlavorAssets.Add((KalturaFlavorAsset)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
				}
			}
		...
		public override KalturaParams ToParams()
		{
			...
			if (this.AccessControlActions != null)
			{
				...
				{
					int i = 0;
					foreach (KalturaAccessControlAction item in this.AccessControlActions)
					{
