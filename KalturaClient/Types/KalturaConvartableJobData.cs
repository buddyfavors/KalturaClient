			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "srcFileSyncs":
						...
						{
							this.SrcFileSyncs.Add((KalturaSourceFileSyncDescriptor)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "engineVersion":
					...
					case "flavorParamsOutput":
						this.FlavorParamsOutput = (KalturaFlavorParamsOutput)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "mediaInfoId":
					...
					case "pluginData":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.PluginData.Add((KalturaKeyValue)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
				}
			}
