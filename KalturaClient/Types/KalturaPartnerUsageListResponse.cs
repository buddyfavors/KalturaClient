	...
	public class KalturaPartnerUsageListResponse : KalturaObjectBase
	{
		...
		public KalturaPartnerUsageListResponse(XmlElement node)
		{
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				{
					case "total":
						this.Total = (KalturaVarPartnerUsageItem)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "objects":
						this.Objects = new List<KalturaVarPartnerUsageItem>();
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.Objects.Add((KalturaVarPartnerUsageItem)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "totalCount":
