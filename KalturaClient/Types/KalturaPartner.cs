			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "deliveryTypes":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.DeliveryTypes.Add((KalturaPlayerDeliveryType)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
					case "embedCodeTypes":
						...
						foreach(XmlElement arrayNode in propertyNode.ChildNodes)
						{
							this.EmbedCodeTypes.Add((KalturaPlayerEmbedCodeType)KalturaObjectFactory.Create(arrayNode));
						}
						continue;
