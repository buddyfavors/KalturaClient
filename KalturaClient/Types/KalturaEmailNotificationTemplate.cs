			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				...
				switch (propertyNode.Name)
				{
					...
					case "fromName":
						...
						continue;
					case "to":
						this.To = (KalturaEmailNotificationRecipientProvider)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "cc":
						this.Cc = (KalturaEmailNotificationRecipientProvider)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "bcc":
						this.Bcc = (KalturaEmailNotificationRecipientProvider)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "replyTo":
						this.ReplyTo = (KalturaEmailNotificationRecipientProvider)KalturaObjectFactory.Create(propertyNode);
						continue;
					case "priority":
