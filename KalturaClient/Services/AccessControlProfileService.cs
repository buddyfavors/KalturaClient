...
namespace Kaltura
{
	...
	public KalturaAccessControlProfileService(KalturaClient client)
		...
		public KalturaAccessControlProfile Add(KalturaAccessControlProfile accessControlProfile)
		{
			...
			_Client.QueueServiceCall("accesscontrolprofile", "add", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaAccessControlProfile)KalturaObjectFactory.Create(result);
		}
		...
		public KalturaAccessControlProfile Get(int id)
		{
			...
			_Client.QueueServiceCall("accesscontrolprofile", "get", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaAccessControlProfile)KalturaObjectFactory.Create(result);
		...
		public KalturaAccessControlProfile Update(int id, KalturaAccessControlProfile accessControlProfile)
		{
			...
			if (accessControlProfile != null)
				kparams.Add("accessControlProfile", accessControlProfile.ToParams());
			_Client.QueueServiceCall("accesscontrolprofile", "update", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaAccessControlProfile)KalturaObjectFactory.Create(result);
		...
		public void Delete(int id)
		{
			KalturaParams kparams = new KalturaParams();
			kparams.AddIntIfNotNull("id", id);
			_Client.QueueServiceCall("accesscontrolprofile", "delete", kparams);
			if (this._Client.IsMultiRequest)
				return;
			XmlElement result = _Client.DoQueue();
		}
		...
		public KalturaAccessControlProfileListResponse List(KalturaAccessControlProfileFilter filter, KalturaFilterPager pager)
		{
			...
			_Client.QueueServiceCall("accesscontrolprofile", "list", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaAccessControlProfileListResponse)KalturaObjectFactory.Create(result);
		}
	}
}
