...
namespace Kaltura
{
	...
	public KalturaCategoryEntryService(KalturaClient client)
		...
		public KalturaCategoryEntry Add(KalturaCategoryEntry categoryEntry)
		{
			...
			_Client.QueueServiceCall("categoryentry", "add", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaCategoryEntry)KalturaObjectFactory.Create(result);
		}
		...
		public void Delete(string entryId, int categoryId)
		{
			...
			_Client.QueueServiceCall("categoryentry", "delete", kparams);
			if (this._Client.IsMultiRequest)
				return;
			XmlElement result = _Client.DoQueue();
		}
		...
		public KalturaCategoryEntryListResponse List(KalturaCategoryEntryFilter filter, KalturaFilterPager pager)
		{
			...
			_Client.QueueServiceCall("categoryentry", "list", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaCategoryEntryListResponse)KalturaObjectFactory.Create(result);
		}
		...
		public int Index(string entryId, int categoryId, bool shouldUpdate)
		{
			...
			_Client.QueueServiceCall("categoryentry", "index", kparams);
			if (this._Client.IsMultiRequest)
				return 0;
			XmlElement result = _Client.DoQueue();
		...
		public void Activate(string entryId, int categoryId)
		{
			...
			kparams.AddStringIfNotNull("entryId", entryId);
			kparams.AddIntIfNotNull("categoryId", categoryId);
			_Client.QueueServiceCall("categoryentry", "activate", kparams);
			if (this._Client.IsMultiRequest)
				return;
			XmlElement result = _Client.DoQueue();
		}
		...
		public void Reject(string entryId, int categoryId)
		{
			...
			kparams.AddStringIfNotNull("entryId", entryId);
			kparams.AddIntIfNotNull("categoryId", categoryId);
			_Client.QueueServiceCall("categoryentry", "reject", kparams);
			if (this._Client.IsMultiRequest)
				return;
			XmlElement result = _Client.DoQueue();
		}
