...
namespace Kaltura
{
	...
	public KalturaThumbParamsOutputService(KalturaClient client)
		...
		public KalturaThumbParamsOutput Get(int id)
		{
			...
			_Client.QueueServiceCall("thumbparamsoutput", "get", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaThumbParamsOutput)KalturaObjectFactory.Create(result);
		}
		...
		public KalturaThumbParamsOutputListResponse List(KalturaThumbParamsOutputFilter filter, KalturaFilterPager pager)
		{
			...
			_Client.QueueServiceCall("thumbparamsoutput", "list", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
