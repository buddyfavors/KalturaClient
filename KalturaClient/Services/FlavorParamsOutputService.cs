...
namespace Kaltura
{
	...
	public KalturaFlavorParamsOutputService(KalturaClient client)
		...
		public KalturaFlavorParamsOutput Get(int id)
		{
			...
			_Client.QueueServiceCall("flavorparamsoutput", "get", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaFlavorParamsOutput)KalturaObjectFactory.Create(result);
		}
		...
		public KalturaFlavorParamsOutputListResponse List(KalturaFlavorParamsOutputFilter filter, KalturaFilterPager pager)
		{
			...
			_Client.QueueServiceCall("flavorparamsoutput", "list", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
