...
namespace Kaltura
{
	...
	public KalturaDocumentService(KalturaClient client)
		...
		public KalturaDocumentEntry UpdateContent(string entryId, KalturaResource resource, int conversionProfileId)
		{
			...
			kparams.AddIntIfNotNull("conversionProfileId", conversionProfileId);
			_Client.QueueServiceCall("document", "updateContent", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaDocumentEntry)KalturaObjectFactory.Create(result);
		...
		public KalturaDocumentEntry ApproveReplace(string entryId)
		{
			KalturaParams kparams = new KalturaParams();
			kparams.AddStringIfNotNull("entryId", entryId);
			_Client.QueueServiceCall("document", "approveReplace", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaDocumentEntry)KalturaObjectFactory.Create(result);
		...
		public KalturaDocumentEntry CancelReplace(string entryId)
		{
			KalturaParams kparams = new KalturaParams();
			kparams.AddStringIfNotNull("entryId", entryId);
			_Client.QueueServiceCall("document", "cancelReplace", kparams);
			if (this._Client.IsMultiRequest)
				return null;
			XmlElement result = _Client.DoQueue();
			return (KalturaDocumentEntry)KalturaObjectFactory.Create(result);
