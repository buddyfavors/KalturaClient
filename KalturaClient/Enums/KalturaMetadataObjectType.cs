...
namespace Kaltura
{
	...
	{
		public static readonly KalturaMetadataObjectType AD_CUE_POINT = new KalturaMetadataObjectType("adCuePoint.AdCuePoint");
		public static readonly KalturaMetadataObjectType ANNOTATION = new KalturaMetadataObjectType("annotation.Annotation");
		public static readonly KalturaMetadataObjectType CODE_CUE_POINT = new KalturaMetadataObjectType("codeCuePoint.CodeCuePoint");
