...
namespace Kaltura
{
	public sealed class KalturaBatchJobOrderBy : KalturaStringEnum
	{
		...
		public static readonly KalturaBatchJobOrderBy LOCK_EXPIRATION_ASC = new KalturaBatchJobOrderBy("+lockExpiration");
		...
		public static readonly KalturaBatchJobOrderBy LOCK_EXPIRATION_DESC = new KalturaBatchJobOrderBy("-lockExpiration");
